...
\label{sec:modiv}
% Outline
In this section, we first derive an approximated upper bound in closed form of
...
approximated with the pair-wise error probability
(PEP)~\cite{harvind2005symbol}:
\begin{align}
