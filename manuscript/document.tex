...
\begin{proposition}
  ...
  \begin{subequations}
    \begin{align}
      ...
      \tilde{\alpha} & = \sqrt{\frac{P_R}{\beta_{h_1}P_1 + \beta_{h_2}P_2+\sigma_R^2}},
    \end{align}
  \end{subequations}
...
\begin{figure}[htb]
  ...
  \begin{minipage}[b]{.48\linewidth}
    \centering
    \centerline{\includegraphics[width=4.5cm]{./figs/BER_noise_power_approx_16QAM.eps}}
    \centerline{(a) Approximated}\medskip
  \end{minipage}
  \hfill
  \begin{minipage}[b]{0.48\linewidth}
    \centering
    \centerline{\includegraphics[width=4.5cm]{./figs/BER_noise_power_MonteCarlo_16QAM.eps}}
    \centerline{(b) Monte-Carlo}\medskip
  \end{minipage}
  %
  \caption{Uncoded BER vs the noise power for 16-QAM.}
...
\begin{figure}[htb]
  ...
  \begin{minipage}[b]{.48\linewidth}
    \centering
    \centerline{\includegraphics[width=4.5cm]{./figs/BER_distance_approx_16QAM.eps}}
    \centerline{(a) Approximated}\medskip
  \end{minipage}
  \hfill
  \begin{minipage}[b]{0.48\linewidth}
    \centering
    \centerline{\includegraphics[width=4.5cm]{./figs/BER_distance_MonteCarlo_16QAM.eps}}
    \centerline{(b) Monte-Carlo}\medskip
  \end{minipage}
  %
  \caption{Uncoded BER vs the position of the relay node for 16-QAM.}
